...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2023 at 01:27 PM
...
(1, 'Comito Pvt Ltd', 'comito@gmail.com', 'yaounde', 'comito'),
(2, 'SataraITSolution', 'SIT@gmail.com', 'douala', 'SIT'),
(3, 'AOJP', 'aojp@gmail.com', 'bamenda', 'aojp'),
(4, 'Pacific Coast Healthcare', 'pchealthcare@gmail.com', 'bafoussam', 'pch'),
(5, 'Absolute Consulting Group', 'absoluteconsgroup@gmail.com', 'yaounde', 'acg'),
(6, 'Go2Group LLC', 'go2group@gmail.com', 'garoua         ', 'go2'),
(7, 'Visionaire Partners', 'visionairepartners@gmail.com', 'yaounde', 'Visionaire');
...
(5, 1, 'Assistant manager', 'Full Time', '2023-10-05', 200000, 2, 'Someone who can help manage company with manager                '),
(6, 1, 'web developer', 'Full Time', '2023-10-06', 250000, 3, 'Skilled in wordpress                       '),
(7, 2, 'Graphic designer', 'Full-Time', '2023-09-26', 200000, 1, 'Skilled in abode'),
(8, 2, 'Programmer', 'part-Time', '2023-09-03', 200000, 3, 'Skilled in java,python'),
(9, 6, 'secretary', 'Full-Time', '2023-10-09', 200000, 2, 'Skilled in ms word and communication'),
...
(11, 1, 'data analysts ', 'Full Time', '2023-08-23', 200000, 2, 'looking for someone who can analys data                         ');
...
--
ALTER TABLE `under_scrutiny`
  MODIFY `us_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
